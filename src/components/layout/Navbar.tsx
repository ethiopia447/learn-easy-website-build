        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className="font-bold text-xl">LearnEasy</Link>
            </div>
          ...
          <div className="md:hidden flex items-center">
            <button
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-purple-200 hover:bg-primary-dark"
              aria-expanded="false"
              onClick={toggleMenu}
            >
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1">
          <Link
            ...
            className="block px-3 py-2 rounded-md text-base font-medium hover:bg-primary-dark hover:text-white"
          >
            Home
          </Link>
          <Link
